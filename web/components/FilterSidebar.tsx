...
export function FilterSidebar({ filters, options, resultCount }: FilterSidebarProps) {
  ...
  return (
    <aside className="rounded-xl border border-slate-200/80 bg-white p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] lg:sticky lg:top-24 lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto">
